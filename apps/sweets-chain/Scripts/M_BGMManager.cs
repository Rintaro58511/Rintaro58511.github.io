...
public class M_BGMManager : MonoBehaviour
{
    private static M_BGMManager instance = null;

    // BGMを保持するシーンのリストを設定 (MenuSceneとMemoSceneのみ)
    public string[] scenesToKeepBGM = { "MenuScene", "MemoScene" };

    public static M_BGMManager Instance
    {
        get { return instance; }
    }
    ...
    void Awake()
    {
        // すでにインスタンスが存在している場合は、このオブジェクトを破棄
